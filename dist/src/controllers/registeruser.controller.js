...
class userController {
    createUser = async (req, res) => {
        try {
            ...
            const token = jwt.sign({ userId: user.id, email: user.email, firstname: user.firstname }, process.env.VERIFICATION_JWT_SECRET || '', { expiresIn: process.env.EXPIRATION_TIME });
